#
# The CEIRRDataSubmission application
#
...
my $script = Bio::KBase::AppService::AppScript->new(\&process_ceirrdatasubmission, \&preflight);
...
sub preflight
{
    ...
    print STDERR "preflight ceirrdatasubmission ", Dumper($params, $app);
...
sub process_ceirrdatasubmission
{
    my($app, $app_def, $raw_params, $params) = @_;

    print 'Proc ceirr data submission ', Dumper($app_def, $raw_params, $params);
    ...
    my @cmd = ("run_ceirr_data_submission","-o",$work_dir,"--jfile", $jdesc);
